...
for id_f in range(1):
    ...
    imu_start_measurement = np.where(time_imu_unalign > moment_imu_start_measurement)[0][0] + 100 # +100 to take off 1sec after start the measurement
    ...
    print(tango_position_align.shape)
